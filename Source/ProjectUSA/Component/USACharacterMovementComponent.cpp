...
float UUSACharacterMovementComponent::GetGravityZ() const
{
	...
	//If you are jumping, including jumping, strong gravity is applied.
	if (Velocity.Z > 0)
	{
	...
	else
	{
		...
		//If you are taking damage, fall more slowly for an easier aerial combo.
		...
		//Fall slowly compared to jumping
		else
		{
